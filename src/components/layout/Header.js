...
import ProfileUser from "./item/ProfileUser";
import { getProfile } from "@/services/auth.service";
import { useDispatch, useSelector } from "react-redux";
import { usersSlice } from "@/redux/slice/usersSlice";
const { upadateLoading, updateProfile } = usersSlice.actions;
import LoadingMax from "../Loadings/LoadingMax";
const Header = () => {
        ...
        <div className="mx-auto ">
          <div className="flex items-stretch justify-between h-16">
            <div className="flex items-center pl-6">
              <div className="text-white pl-1 cursor-pointer hidden md:block">
                <span>
                ...
                <form action="" className="app-search" method="GET">
                  <div className="relative group ">
                    <input
                      ...
                      placeholder="Search..."
                    />
                    <span className="absolute left-44 bottom-2 text-gray-400 transition-all duration-300 ease-in-out group-focus-within:left-8">
                      <svg
